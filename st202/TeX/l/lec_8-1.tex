...
\begin{definition}
		The \textbf{joint cumulative distribution function} of $X_1,\dots,X_n$ is the function $$F_{X_1,\dots,X_n}(x_1,\dots,x_n)=P(X_1\leq x_1,X_2\leq x_2, \ \dots, \ X_n\leq x_n).$$
\end{definition}
